...
//			Dbcp.close(null, stmt, conn);
		}
	}

	public static void main(String[] args) throws Exception {
//		List<String> sqlList = new SqlFileExecutor().loadSql( "config/user_base.sql" );
...
////			o.prepareStatement( "" );josn
//			o.executeUpdate();
//		}
		DBObject o = DBObject.create();
		
		o.prepareStatement( "SHOW TABLES LIKE 'user_bas'" );
		o.executeQuery();
		if( o.next() ){
		...
		o.prepareStatement( "DESC role id" );
		o.executeQuery();
		if( o.next() ){
