...
public class Tool {
	...
	public static String dchange(int str) {
		String result = str == 4 ? "精" : (str == 3 ? "神" : (str == 2 ? "通"
				: "疏"));
		return result;
	}
	...
	public static double juli(General g1, General g2) {
		double result = (Double) Math.sqrt(StrictMath.pow(
				g1.getRender() - g2.getRender(), 2)
				...
				+ StrictMath.pow(
						g1.getTongwuzhizheng() - g2.getTongwuzhizheng(), 2)
